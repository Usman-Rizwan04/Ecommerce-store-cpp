...
namespace {
struct qt_meta_tag_ZN12SignupScreenE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12SignupScreenE = QtMocHelpers::stringData(
    "SignupScreen",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12SignupScreenE[] = {
...
Q_CONSTINIT const QMetaObject SignupScreen::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12SignupScreenE.offsetsAndSizes,
    qt_meta_data_ZN12SignupScreenE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12SignupScreenE_t,
        // Q_OBJECT / Q_GADGET
...
void *SignupScreen::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12SignupScreenE.stringdata0))
